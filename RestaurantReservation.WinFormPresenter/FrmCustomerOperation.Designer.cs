...
partial class FrmCustomerOperation
{
    ...
    private void InitializeComponent()
    {
        ...
        gbxCustomerOperations.Location = new Point(12, 12);
        ...
        ClientSize = new Size(1247, 813);
        Controls.Add(gbxCustomerOperations);
        Controls.Add(gbxCustomerList);
        Font = new Font("Segoe UI", 14F);
        Margin = new Padding(5);
        Name = "FrmCustomerOperation";
        Text = "Customer Operation";
        Load += FrmCustomerOperation_Load;
